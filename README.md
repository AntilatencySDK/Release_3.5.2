...
Git command to clone this subset: `git clone --branch subset-32b8bd33fdf61092e6a0eb083dec18fe7e356c78 --single-branch https://github.com/AntilatencySDK/Release_3.5.2.git`
