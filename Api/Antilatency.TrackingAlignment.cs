	...
	namespace Details {
		...
		public class ITrackingAlignmentRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			...
			protected static new void AppendVmt(System.Collections.Generic.List<object> buffer) {
				...
				var vmt = new VMT();
				vmt.update = (System.IntPtr _this, Antilatency.Math.floatQ a, Antilatency.Math.floatQ b, float time, out Antilatency.TrackingAlignment.State result) => {
					try {
	...
	namespace Details {
		...
		public class ILibraryRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			...
			protected static new void AppendVmt(System.Collections.Generic.List<object> buffer) {
				Antilatency.InterfaceContract.Details.IInterfaceRemap.AppendVmt(buffer);
				var vmt = new VMT();
				vmt.createTrackingAlignment = (System.IntPtr _this, Antilatency.Math.floatQ initialARelativeToB, float initialTimeBAheadOfA, out System.IntPtr result) => {
					try {
